...
promotionRouter
  ...
  .post(
    ...
    (req, res, next) => {
      // creating a new document in the promotion collection
  ...
  .delete(
    ...
    authenticate.verifyAdmin,
    (req, res, next) => {
      // delete request that is deleting any documents in the promotion collection
...
promotionRouter
  ...
  .get(cors.cors, (req, res, next) => {
    // get request that is getting all promotions with an id matching the requested id
  ...
  .put(
    ...
    authenticate.verifyAdmin,
    (req, res, next) => {
      // put request that is updating any promotions that have an id matching the id requested
  ...
  .delete(
    ...
    authenticate.verifyAdmin,
    (req, res, next) => {
      // delete request that is deleting any promotions that have an id matching the id requested
